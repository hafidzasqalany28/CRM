            ...
            <div class="card-body d-flex flex-column">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item {{ $productPromo ? 'text-info' : 'text-muted' }}">
                        ...
                        @if ($productPromo)
                        {{ $productPromo->description }} - <span class="badge bg-info text-white">{{
                            $productPromo->discount }}%</span>
                        % off until {{ $productPromo->end_date }}
                        @else
                        No active promotions currently
                        @endif
                    </li>
                    <li class="list-group-item">
                        <i class="fas fa-box text-warning"></i> {{ $product->stock - $product->orders->sum('quantity')
                        }} pieces available
                    </li>
                </ul>
                <div class="mt-auto">
