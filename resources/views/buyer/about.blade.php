    ...
    <div class="container">
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <div class="mb-4">
                    <i class="fa fa-check text-black me-3"></i>Discover the natural growth process and cultivation
                    techniques<br>
                    <i class="fa fa-check text-black me-3"></i>Experience the unique flavors and varieties of sweet
                    potatoes<br>
                    <i class="fa fa-check text-black me-3"></i>Learn about the biologically safe practices followed by
                    local farmers<br>
                    <i class="fa fa-check text-black me-3"></i>Explore the cultural significance of sweet potatoes in
                    the community<br>
                    <i class="fa fa-check text-black me-3"></i>Explore sweet potatoes' contribution to organic and
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="bg-white text-center h-100 p-4 p-xl-5 rounded">
                            ...
                            <p class="mb-4">Discover the natural process behind our sweet potatoes. Lorem ipsum dolor
                                sit
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="bg-white text-center h-100 p-4 p-xl-5 rounded">
                            ...
                            <p class="mb-4">Explore our range of organic sweet potato products. Lorem ipsum dolor sit
                                amet,
