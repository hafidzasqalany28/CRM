    ...
    <div class="container">
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 mb-4 wow fadeIn" data-wow-delay="0.1s">
                <div class="about-img position-relative overflow-hidden p-5 pe-md-0">
            ...
            <div class="col-lg-6 mb-4 wow fadeIn" data-wow-delay="0.5s">
                ...
                <p class="mb-4 text-black">Eksplorasi dunia ubi jalar yang kaya dan beragam di KAMPUNG BERSEHATI,
                    ...
                    serbaguna ini yang telah menjadi makanan pokok di komunitas setempat.</p>
                <div class="mb-4">
        ...
        <div class="container-fluid bg-light bg-icon py-6">
            <div class="container">
                ...
                <div class="row g-4">
                    <!-- Natural Process -->
                    <div class="col-lg-4 col-md-6 mb-4 wow fadeIn" data-wow-delay="0.1s">
                        <div class="bg-white text-center h-100 p-4 p-xl-5 rounded">
                            ...
                            <p class="mb-4">Temukan proses alami di balik ubi jalar kami. Mengetahui lebih lanjut
                                tentang bagaimana kami membudidayakan ubi jalar secara organik dan menghormati
                                lingkungan.</p>
                            <a class="btn btn-outline-dark rounded-pill" href="#">Selengkapnya</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 wow fadeIn" data-wow-delay="0.3s">
                        <div class="bg-white text-center h-100 p-4 p-xl-5 rounded">
                            ...
                            <p class="mb-4">Jelajahi rangkaian produk ubi jalar organik kami. Temukan bagaimana kami
                                menghasilkan produk berkualitas tinggi yang ramah lingkungan dan bebas bahan kimia.</p>
                            <a class="btn btn-outline-dark rounded-pill" href="#">Selengkapnya</a>
                        </div>
                    </div>

                    <!-- Biologically Safe -->
                    <div class="col-lg-4 col-md-6 mb-4 wow fadeIn" data-wow-delay="0.5s">
                        <div class="bg-white text-center h-100 p-4 p-xl-5 rounded">
                            ...
                            <p class="mb-4">Rasakan ubi jalar yang aman secara biologis. Pelajari lebih lanjut tentang
                                bagaimana kami menjaga keamanan produk kami dengan praktik pertanian yang ramah
                                lingkungan.</p>
                            <a class="btn btn-outline-dark rounded-pill" href="#">Selengkapnya</a>
                        </div>
                    </div>
